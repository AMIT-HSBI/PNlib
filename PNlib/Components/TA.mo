...
model TA "Test Arc"
  ...
  parameter Boolean realTestArc = true "real Test arc >, Test arc >=" annotation(
    Dialog(enable = true, group = "Test Arc"));
  parameter Boolean normalArc = true "Double arc: test and normal arc?" annotation(
    Dialog(enable = true, group = "Test Arc"));
