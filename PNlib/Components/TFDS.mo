...
model TFDS "Stochastic Transition with fire duration"
  ...
  parameter Integer localSeed = PNlib.Functions.Random.counter() "Local seed to initialize random number generator" annotation(
...
initial algorithm
  ...
  annotation(
    ...
    Icon(graphics = {Rectangle(extent = {{-40, 100}, {40, -100}}, lineColor = {0, 0, 0}, fillColor = DynamicSelect({0, 0, 0}, color), fillPattern = FillPattern.Solid), Text(origin = {-3, 8}, lineColor = {255, 255, 255}, fillColor = {255, 255, 255}, extent = {{-35, 42}, {43, -52}}, textString = "S"), Text(extent = {{-2, -112}, {-2, -140}}, lineColor = {0, 0, 0}, textString = DynamicSelect("%distributionType ", if animateHazardFunc then "%distributionType" else " ")), Text(extent = {{-2, -152}, {-2, -180}}, lineColor = {0, 0, 0}, textString = DynamicSelect("fd=?", if animateputDuration then "fd=" + String(putDuration) else " ")), Text(extent = {{-4, 139}, {-4, 114}}, lineColor = {0, 0, 0}, textString = "%name")}));
end TFDS;
