...
model InputConflictType3
  ...
  PNlib.Components.PC P1(nIn = 2, nOut = 1, maxMarks=2) annotation(Placement(transformation(extent={{10, -10}, {30, 10}})));
  PNlib.Components.TC T1(nIn = 1) annotation(Placement(transformation(extent = {{40, -10}, {60, 10}})));
  PNlib.Components.TD T2(nIn = 1, nOut = 1) annotation(Placement(transformation(extent = {{-20, 10}, {0, 30}})));
  PNlib.Components.TC T3(nIn = 1, nOut = 1, maximumSpeed=2) annotation(Placement(transformation(extent = {{-20, -30}, {0, -10}})));
  PNlib.Components.PD P2(startTokens = 5, nOut = 1) annotation(Placement(transformation(extent = {{-50, 10}, {-30, 30}})));
  PNlib.Components.PC P3(nOut = 1, startMarks=5) annotation(Placement(transformation(extent = {{-50, -30}, {-30, -10}})));
