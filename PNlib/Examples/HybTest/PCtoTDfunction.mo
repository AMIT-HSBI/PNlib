...
model PCtoTDfunction
  ...
  PNlib.PC P1(nOut=1, startMarks=5) annotation(Placement(transformation(extent = {{-30, -10}, {-10, 10}})));
  PNlib.TD T1(nIn=1, arcWeightIn={P1.t}) annotation(Placement(transformation(extent = {{10, -10}, {30, 10}})));
equation
