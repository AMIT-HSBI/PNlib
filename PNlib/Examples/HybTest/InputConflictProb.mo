...
model InputConflictProb
  ...
  PNlib.PC P1(nIn = 2, nOut = 1, enablingType = 2, maxMarks=2) annotation(Placement(transformation(extent = {{10, -10}, {30, 10}})));
  ...
  PNlib.PD P3(startTokens = 5, enablingType = 1, nOut = 1) annotation(Placement(transformation(extent = {{-50, -30}, {-30, -10}})));
