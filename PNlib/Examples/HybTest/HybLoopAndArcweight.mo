...
model HybLoopAndArcweight
  ...
  PNlib.Components.PC P1(nOut = 1, nIn = 1, startMarks=2) annotation(Placement(transformation(extent = {{-10, -30}, {10, -10}})));
  PNlib.Components.TD T1(nIn = 1, nOut = 1, arcWeightIn={1.5}, arcWeightOut={2.5}) annotation(Placement(transformation(extent = {{8, 10}, {-12, 30}})));
  inner PNlib.Components.Settings settings annotation(Placement(transformation(extent = {{20, 40}, {40, 60}})));
equation
