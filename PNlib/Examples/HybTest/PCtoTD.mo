...
model PCtoTD
  ...
  PNlib.Components.PC P1(nOut=1, startMarks=8) annotation(Placement(transformation(extent = {{-30, -10}, {-10, 10}})));
  PNlib.Components.TD T1(nIn=1, delay=1, arcWeightIn={1}) annotation(Placement(transformation(extent = {{10, -10}, {30, 10}})));
equation
