...
model TDtoPCfunction
  ...
  PNlib.Components.PC P1(nIn = 1, startMarks=5) annotation(Placement(visible = true, transformation(origin = {20, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  PNlib.Components.TD T1(nOut = 1, arcWeightOut={P1.t}) annotation(Placement(visible = true, transformation(origin = {-20, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
