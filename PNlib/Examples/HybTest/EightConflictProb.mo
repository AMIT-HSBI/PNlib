...
model EightConflictProb
  ...
  PNlib.Components.PC P1(enablingType = PNlib.Types.EnablingType.Probability, nOut = 8, startMarks=1,
    localSeedIn=1,
  ...
  PNlib.Components.TD T5(nIn = 1) annotation(Placement(transformation(extent = {{40, -30}, {60, -10}})));
  PNlib.Components.TD T6(nIn = 1) annotation(Placement(transformation(extent = {{-20, -50}, {0, -30}})));
  PNlib.Components.TD T7(nIn = 1) annotation(Placement(transformation(extent = {{20, -40}, {40, -20}})));
