...
model ConflictType3
  ...
  PNlib.Components.PC P1(nIn = 1, nOut = 2, startMarks = 2) annotation(
    Placement(transformation(extent = {{-30, -10}, {-10, 10}})));
  PNlib.Components.TC T1(nIn = 1, nOut = 1, maximumSpeed = 2) annotation(
  ...
  PNlib.Components.TC T3(nOut = 1) annotation(
