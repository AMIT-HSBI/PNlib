...
model TCwithPD
  ...
  PNlib.TC T1(nIn=2, nOut=2, arcWeightIn={2,1}, firingCon=true) annotation(Placement(transformation(extent={{-10,10},{10,30}})));
  PNlib.PD P3(nOut=1, nIn=1, enablingType=1, startTokens=10) annotation(Placement(transformation(extent={{10,-20},{-10,0}})));
equation
