...
model TCwithPD
  ...
  PNlib.Components.TC T1(nIn=2, nOut=2, arcWeightIn={2,1}, firingCon=true) annotation(Placement(transformation(extent={{-10,10},{10,30}})));
  PNlib.Components.PD P3(nOut=1, nIn=1, startTokens=10) annotation(Placement(transformation(extent={{10,-20},{-10,0}})));
equation
  connect(P1.outTransition[1], T1.inPlaces[1]) annotation(Line(points={{-29.2, 20},{-28,20},{-16,20},{-16,19.5},{-4.8,19.5}}, color={0,0,0}));
