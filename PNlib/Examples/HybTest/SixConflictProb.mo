...
model SixConflictProb
  ...
  PNlib.PC P1(enablingType = 2, nOut = 6, startMarks=1) annotation(Placement(transformation(extent = {{-50, -10}, {-30, 10}})));
  ...
  PNlib.TD T4(nIn = 1) annotation(Placement(transformation(extent = {{20, -30}, {40, -10}})));
...
equation
  connect(P1.outTransition[1], T1.inPlaces[1]) annotation(Line(points={{-29.2,-0.833333},{-20,-0.833333},{-20,40},{-14.8,40}}, color = {0, 0, 0}, smooth = Smooth.None));
  ...
  connect(T3.inPlaces[1], P1.outTransition[3]) annotation(Line(points={{25.2,20},{20,20},{20,-0.166667},{-29.2,-0.166667}}, color = {0, 0, 0}, smooth = Smooth.None));
  connect(T4.inPlaces[1], P1.outTransition[4]) annotation(Line(points={{25.2,-20},{20,-20},{20,0.166667},{-29.2,0.166667}}, color = {0, 0, 0}, smooth = Smooth.None));
  ...
  connect(T6.inPlaces[1], P1.outTransition[6]) annotation(Line(points={{-14.8,-40},{-20,-40},{-20,0.833333},{-29.2,0.833333}}, color = {0, 0, 0}, smooth = Smooth.None));
