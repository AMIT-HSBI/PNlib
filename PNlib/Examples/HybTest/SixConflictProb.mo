...
model SixConflictProb
  ...
  PNlib.Components.PC P1(enablingType = PNlib.Types.EnablingType.Probability, nOut = 6, startMarks=1,
    localSeedIn=1,
  ...
  PNlib.Components.TD T2(nIn = 1) annotation(Placement(transformation(extent = {{0, 20}, {20, 40}})));
  PNlib.Components.TD T3(nIn = 1) annotation(Placement(transformation(extent = {{20, 10}, {40, 30}})));
  PNlib.Components.TD T4(nIn = 1) annotation(Placement(transformation(extent = {{20, -30}, {40, -10}})));
  PNlib.Components.TD T5(nIn = 1) annotation(Placement(transformation(extent = {{0, -40}, {20, -20}})));
  PNlib.Components.TD T6(nIn = 1) annotation(Placement(transformation(extent = {{-20, -50}, {0, -30}})));
