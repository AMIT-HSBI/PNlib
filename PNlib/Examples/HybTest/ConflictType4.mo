...
model ConflictType4
  ...
  PNlib.Components.PC P3(nOut = 1, startMarks = 10) annotation(
  ...
  PNlib.Components.TC T1(nIn = 2, nOut = 2) annotation(
    Placement(transformation(extent = {{-10, -50}, {10, -30}})));
  PNlib.Components.TC T2(nIn = 2, nOut = 2) annotation(
    Placement(transformation(extent = {{-10, 10}, {10, 30}})));
  PNlib.Components.PD P5(nOut = 2, nIn = 2, startTokens = 1) annotation(
...
equation
  ...
  connect(T2.outPlaces[2], P5.inTransition[1]) annotation(
    Line(points = {{4.8, 20.5}, {20, 20.5}, {20, -10.5}, {10.8, -10.5}}, color = {0, 0, 0}));
