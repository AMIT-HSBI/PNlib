...
model ConflictType4
  ...
  PNlib.Components.PC P1(nOut=1, startMarks=10) annotation(Placement(transformation(extent={{-50, 10}, {-30, 30}})));
  PNlib.Components.PC P2(nIn=1) annotation(Placement(transformation(extent={{30, 10}, {50, 30}})));
  PNlib.Components.PC P3(nOut=1, startMarks=10) annotation(Placement(transformation(extent={{-50, -50}, {-30, -30}})));
  PNlib.Components.PC P4(nIn=1) annotation(Placement(transformation(extent={{30, -50}, {50, -30}})));
  PNlib.Components.TC T1(nIn=2, nOut=2) annotation(Placement(transformation(extent={{-10, -50}, {10, -30}})));
  PNlib.Components.TC T2(nIn=2, nOut=2) annotation(Placement(transformation(extent={{-10, 10}, {10, 30}})));
  PNlib.Components.PD P5(nOut=2, nIn=2, startTokens=1) annotation(Placement(transformation(extent={{10, -20}, {-10, 0}})));
equation
