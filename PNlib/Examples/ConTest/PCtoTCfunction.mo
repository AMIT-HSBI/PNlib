...
model PCtoTCfunction
  ...
  inner PNlib.Components.Settings settings annotation(Placement(transformation(extent={{20, 20},
            {40, 40}})));
  PNlib.Components.PC P1(nOut = 1, startMarks = 1) annotation(Placement(transformation(extent={{-10, -10},
            {10, 10}})));
  PNlib.Components.TC T1(arcWeightIn = {P1.t}, nIn = 1) annotation(Placement(transformation(extent={{20, -10}, {40,
            10}})));
equation
