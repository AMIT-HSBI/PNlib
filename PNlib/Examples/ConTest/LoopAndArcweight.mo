...
model LoopAndArcweight
  ...
  inner PNlib.Components.Settings settings annotation(Placement(transformation(extent={{-40, 20},
            {-20, 40}})));
  PNlib.Components.PC P1(nOut = 1, nIn = 1, startMarks = 1) annotation(Placement(transformation(extent={{-10, -10},
            {10, 10}},
        rotation=180,
        origin={0, -30})));
  PNlib.Components.TC T1(nIn = 1, nOut = 2, arcWeightIn = {3}, arcWeightOut = {2, 2}) annotation(Placement(transformation(extent = {{10, -10}, {-10, 10}}, rotation=180, origin={0, 0})));
  PNlib.Components.PC P2(nIn = 1) annotation(Placement(transformation(extent={{10, -10}, {-10, 10}}, rotation=270, origin={20, 30})));
equation
