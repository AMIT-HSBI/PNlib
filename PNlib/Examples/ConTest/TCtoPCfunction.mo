...
model TCtoPCfunction
  ...
  inner PNlib.Settings settings annotation(Placement(transformation(extent={{20, 20},
            {40, 40}})));
  PNlib.TC T1(arcWeightOut = {P1.t}, nOut = 1) annotation(Placement(transformation(extent={{-40, -10}, {
            -20, 10}})));
  PNlib.PC P1(nIn = 1, startMarks = 1) annotation(Placement(transformation(extent={{-10, -10}, {
            10, 10}})));
equation
