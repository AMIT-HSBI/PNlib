...
model IATest
  ...
  inner PNlib.Components.Settings settings annotation(Placement(transformation(extent={{100, 20}, {120, 40}})));
  PNlib.Components.IA IA1(normalArc=false, testValue=1) annotation(Placement(transformation(extent={{-44, -2}, {-30, 2}})));
  PNlib.Components.IA IA2(testValue=2) annotation(Placement(transformation(extent={{-6, -3}, {6, 3}}, rotation=0, origin={50, -1})));
  PNlib.Components.PC P1(nOut=2, nIn=1, startMarks=2) annotation(Placement(transformation(extent={{-70, -10}, {-50, 10}})));
  PNlib.Components.PC P2(nIn=1, nOut=1, startMarks=1) annotation(Placement(transformation(extent={{10, -10}, {30, 10}})));
  PNlib.Components.PC P3(nIn=1) annotation(Placement(transformation(extent={{90, -10}, {110, 10}})));
  ...
  PNlib.Components.TC T3(nIn=2, arcWeightIn={1, 2}, maximumSpeed=2, nOut=1) annotation(Placement(transformation(extent={{-10, -10}, {10, 10}}, rotation=0, origin={80, 0})));
equation
