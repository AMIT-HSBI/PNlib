...
model TDSuniform
  ...
  PNlib.Components.TDS T1(a = 2, b = 4, distributionType = PNlib.Types.DistributionType.Uniform, localSeed = 1, nIn = 1, nOut = 1) annotation(
...
equation
  ...
  annotation(
    ...
    experiment(StartTime = 0.0, StopTime = 20.0, Tolerance = 1e-6));
end TDSuniform;
