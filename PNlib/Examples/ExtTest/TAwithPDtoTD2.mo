...
model TAwithPDtoTD2
  ...
  PNlib.Components.PD P1(nOut=2, startTokens=5) annotation(Placement(transformation(extent={{-52, -10}, {-32, 10}})));
  PNlib.Components.PD P2(nIn=1) annotation(Placement(transformation(extent={{30, 20}, {50, 40}})));
  PNlib.Components.PD P3(nIn=1) annotation(Placement(transformation(extent={{30, -40}, {50, -20}})));
  PNlib.Components.TA TA1(realTestArc = false, testValue = 3) annotation(Placement(transformation(extent={{-18, -36}, {-4, -30}})));
  PNlib.Components.TD T1(nIn=1, nOut=1) annotation(Placement(transformation(extent={{6, 20}, {26, 40}})));
  PNlib.Components.TD T2(nIn=1, nOut=1) annotation(Placement(transformation(extent={{6, -40}, {26, -20}})));
equation
