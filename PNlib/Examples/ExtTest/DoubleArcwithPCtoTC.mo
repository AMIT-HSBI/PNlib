...
equation
  ...
  connect(P1.outTransition[1], TA1.inPlace) annotation(Line(points={{-33.2,-0.5},
          {-30,-0.5},{-30,-31},{-21.1111,-31}},                                                                                 color = {0, 0, 0}));
  ...
  connect(IA1.outTransition, T1.inPlaces[1]) annotation(Line(points={{-6.88889,
          29},{-2.44445,29},{-2.44445,30},{11.2,30}},                                                                               color = {0, 0, 0}));
  connect(IA1.inPlace, P1.outTransition[2]) annotation(Line(points={{-23.1111,
          29},{-23.1111,30},{-30,30},{-30,0},{-33.2,0},{-33.2,0.5}},                                                                                  color = {0, 0, 0}));
