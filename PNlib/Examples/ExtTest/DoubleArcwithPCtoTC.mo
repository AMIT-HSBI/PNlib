...
model DoubleArcwithPCtoTC
  ...
  Components.IA IA1(testValue=3, normalArc=2)
    annotation (Placement(transformation(extent={{-22,26},{-8,32}})));
  Components.PC P1(nOut=2, startMarks=5)
    annotation (Placement(transformation(extent={{-54,-10},{-34,10}})));
  Components.PC P2(nIn=1)
    annotation (Placement(transformation(extent={{30,20},{50,40}})));
  Components.PC P3(nIn=1)
    annotation (Placement(transformation(extent={{30,-40},{50,-20}})));
  Components.TA TA1(testValue=2, normalArc=2)
    annotation (Placement(transformation(extent={{-20,-34},{-6,-28}})));
  Components.TC T1(nOut=1, nIn=1)
    annotation (Placement(transformation(extent={{6,20},{26,40}})));
  Components.TC T2(nIn=1, nOut=1)
