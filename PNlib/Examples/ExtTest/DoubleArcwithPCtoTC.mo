...
model DoubleArcwithPCtoTC
  ...
  PNlib.Components.IA IA1(testValue=3, normalArc=false) annotation(Placement(transformation(extent={{-22, 26}, {-8, 32}})));
  PNlib.Components.PC P1(nOut=2, startMarks=5) annotation(Placement(transformation(extent={{-54, -10}, {-34, 10}})));
  PNlib.Components.PC P2(nIn=1) annotation(Placement(transformation(extent={{30, 20}, {50, 40}})));
  PNlib.Components.PC P3(nIn=1) annotation(Placement(transformation(extent={{30, -40}, {50, -20}})));
  PNlib.Components.TA TA1(testValue=2, normalArc=false) annotation(Placement(transformation(extent={{-20, -34}, {-6, -28}})));
  PNlib.Components.TC T1(nOut=1, nIn=1) annotation(Placement(transformation(extent={{6, 20}, {26, 40}})));
  PNlib.Components.TC T2(nIn=1, nOut=1) annotation(Placement(transformation(extent={{6, -40}, {26, -20}})));
equation
