...
model TDSdiscrete
  ...
  PNlib.Components.PD P1(nOut = 1, startTokens = 18) annotation(
    Placement(transformation(extent = {{-40, -10}, {-20, 10}})));
  PNlib.Components.PD P2(nIn = 1) annotation(
    Placement(transformation(extent = {{20, -10}, {40, 10}})));
  PNlib.Components.TDS T1(distributionType = PNlib.Types.DistributionType.Discrete, localSeed = 1, nIn = 1, nOut = 1) annotation(
...
equation
  ...
  annotation(
    ...
    experiment(StartTime = 0.0, StopTime = 60.0, Tolerance = 1e-6));
end TDSdiscrete;
