...
equation
  ...
  connect(P1.outTransition[1], TA1.inPlace) annotation(Line(points={{-33.2,1.5},
          {-28,1.5},{-28,-29},{-21.1111,-29}},                                                                                color = {0, 0, 0}));
  connect(TA1.outTransition, T2.inPlaces[1]) annotation(Line(points={{-4.88889,
          -29},{1.5556,-29},{1.5556,-28},{11.2,-28}},                                                                               color = {0, 0, 0}));
  connect(T2.outPlaces[1], P3.inTransition[1]) annotation(Line(points = {{20.8, -28}, {29.2, -28}}, color = {0, 0, 0}));
  connect(IA1.inPlace, P1.outTransition[2]) annotation(Line(points={{-24.9524,
          30},{-28,30},{-28,2.5},{-33.2,2.5}},                                                                              color = {0, 0, 0}));
  connect(IA1.outTransition, T1.inPlaces[1]) annotation(Line(points={{-11.0476,
          30},{-11.0476,30},{11.2,30}},                                                                             color = {0, 0, 0}));
