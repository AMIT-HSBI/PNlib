...
model DoubleArcwithPTtoTD
  ...
  Components.IA IA1(testValue=3, normalArc=2)
    annotation (Placement(transformation(extent={{-24,28},{-12,32}})));
  Components.PD P1(nOut=2, startTokens=5)
    annotation (Placement(transformation(extent={{-54,-8},{-34,12}})));
  Components.PD P2(nIn=1)
    annotation (Placement(transformation(extent={{30,20},{50,40}})));
  Components.PD P3(nIn=1)
    annotation (Placement(transformation(extent={{30,-38},{50,-18}})));
  Components.TA TA1(normalArc=2, testValue=2)
    annotation (Placement(transformation(extent={{-20,-32},{-6,-26}})));
  Components.TD T1(nOut=1, nIn=1)
