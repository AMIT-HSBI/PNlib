...
model TStruncatednormal
  ...
  TS T1(distributionType = PNlib.Types.DistributionType.TruncatedNormal,localSeed=1, nIn=1, nOut=1) annotation(Placement(transformation(extent={{-10, -10}, {10, 10}})));
equation
