...
model OutputConflictPrio
  ...
  PNlib.Components.PD P1(nIn = 1, startTokens = 2, nOut = 2, minTokens = 2) annotation(Placement(transformation(extent={{-30, -10},
            {-10, 10}})));
  PNlib.Components.TD T1(nIn = 1, nOut = 1) annotation(Placement(transformation(extent={{0, 10}, {
            20, 30}})));
  PNlib.Components.TD T2(nIn = 1, nOut = 1) annotation(Placement(transformation(extent={{0, -30},
            {20, -10}})));
  PNlib.Components.PD P2(nIn = 1) annotation(Placement(transformation(extent={{30, 10}, {50, 30}})));
  PNlib.Components.PD P3(nIn = 1) annotation(Placement(transformation(extent={{30, -30}, {50,
            -10}})));
  PNlib.Components.TD T3(nOut = 1) annotation(Placement(transformation(extent={{-60, -10}, {-40,
            10}})));
