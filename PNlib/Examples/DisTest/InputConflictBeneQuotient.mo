...
model InputConflictBeneQuotient
  ...
  PNlib.Components.PD P1(benefitType = PNlib.Types.BenefitType.BenefitQuotient,enablingBeneIn = {6, 5}, enablingType = PNlib.Types.EnablingType.Benefit,maxTokens = 5, nIn = 2, nOut = 1) annotation(Placement(transformation(extent={{10, -10},
            {30, 10}})));
  PNlib.Components.TD T1(arcWeightIn = {3}, nIn = 1) annotation(Placement(transformation(extent={{40, -10}, {60,
            10}})));
