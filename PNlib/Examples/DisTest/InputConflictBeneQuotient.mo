...
model InputConflictBeneQuotient
  ...
  PNlib.Components.PD P1(benefitType = PNlib.Types.BenefitType.BenefitQuotient, enablingBeneIn = {6, 5}, enablingType = PNlib.Types.EnablingType.Benefit, maxTokens = 5, nIn = 2, nOut = 1) annotation(
