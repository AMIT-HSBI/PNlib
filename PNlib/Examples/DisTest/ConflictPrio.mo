...
model ConflictPrio
  ...
  PNlib.PD P1(nIn = 1, nOut = 2, startTokens = 2) annotation(Placement(transformation(extent = {{-30, -10}, {-10, 10}})));
  ...
  PNlib.PD P2(enablingType = 1, nIn = 1) annotation(Placement(transformation(extent = {{30, 10}, {50, 30}})));
  PNlib.PD P3(enablingType = 1, nIn = 1) annotation(Placement(transformation(extent = {{30, -30}, {50, -10}})));
