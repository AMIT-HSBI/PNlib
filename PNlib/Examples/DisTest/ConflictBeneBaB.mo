...
model ConflictBeneBaB
  ...
  PNlib.Components.PD P1(nIn = 1) annotation(
    Placement(visible = true, transformation(extent = {{30, 70}, {50, 90}}, rotation = 0)));
  PNlib.Components.TD T1(arcWeightIn = {4}, nIn = 1, nOut = 1) annotation(
    Placement(visible = true, transformation(extent = {{-6, 70}, {14, 90}}, rotation = 0)));
  PNlib.Components.TD T2(arcWeightIn = {3}, nIn = 1, nOut = 1) annotation(
    Placement(visible = true, transformation(extent = {{-6, 30}, {14, 50}}, rotation = 0)));
...
equation
  ...
  annotation(
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-60, -140}, {60, 100}}), graphics),
