...
model ConflictBeneBaB
  ...
  PNlib.PD P1(nIn = 1) annotation(Placement(visible = true, transformation(extent = {{30, 70}, {50, 90}}, rotation = 0)));
  PNlib.TD T1(arcWeightIn = {4},nIn = 1, nOut = 1) annotation(Placement(visible = true, transformation(extent = {{-6, 70}, {14, 90}}, rotation = 0)));
  PNlib.TD T2(arcWeightIn = {3},nIn = 1, nOut = 1) annotation(Placement(visible = true, transformation(extent = {{-6, 30}, {14, 50}}, rotation = 0)));
  PNlib.PD P2(nIn = 1) annotation(Placement(visible = true, transformation(extent = {{30, 30}, {50, 50}}, rotation = 0)));
  PNlib.PD P3(nIn = 1) annotation(Placement(visible = true, transformation(extent = {{30, -10}, {50, 10}}, rotation = 0)));
  inner PNlib.Settings settings annotation(Placement(visible = true, transformation(extent = {{-60, 80}, {-40, 100}}, rotation = 0)));
  PNlib.TD T3(arcWeightIn = {1},nIn = 1, nOut = 1)  annotation(
    Placement(visible = true, transformation(origin = {4, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  PNlib.TD T4(arcWeightIn = {1},nIn = 1, nOut = 1)  annotation(
    Placement(visible = true, transformation(origin = {4, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  PNlib.TD T5(arcWeightIn = {1},nIn = 1, nOut = 1)  annotation(
  ...
  PNlib.TD T7(arcWeightOut = {4},delay = 2, nIn = 1, nOut = 1)  annotation(
    Placement(visible = true, transformation(origin = {-40, -60}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  PNlib.TD T6(arcWeightIn = {1},nIn = 1, nOut = 1)  annotation(
