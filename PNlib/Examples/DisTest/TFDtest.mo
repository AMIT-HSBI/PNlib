...
model TFDtest
  ...
  PNlib.PD P1(nIn = 1, nOut = 1, startTokens = 0) annotation(
    Placement(visible = true, transformation(extent = {{-56, -10}, {-36, 10}}, rotation = 0)));
  ...
  PNlib.TD T2(delay = 2, nOut = 1) annotation(
    Placement(visible = true, transformation(origin = {-68, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  TE T4(event = {3.5}, nIn = 1) annotation(
    Placement(visible = true, transformation(origin = {56, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  connect(P2.outTransition[1], T4.inPlaces[1]) annotation(
    Line(points = {{32, 0}, {50, 0}, {50, 0}, {52, 0}}));
