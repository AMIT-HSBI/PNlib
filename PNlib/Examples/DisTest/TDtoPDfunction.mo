...
model TDtoPDfunction
  ...
  PNlib.TD T1(arcWeightOut = {P1.t}, nOut = 1) annotation(Placement(visible = true, transformation(origin={-20, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  ...
  annotation(Diagram(coordinateSystem(extent={{-40, -40},
            {40, 40}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), experiment(StartTime=0.0, StopTime=5.0, Tolerance = 1e-6));
end TDtoPDfunction;
