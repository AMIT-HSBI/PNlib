...
model ConflictProb
  ...
  PNlib.Components.PD P1(nIn = 1, startTokens = 2, nOut = 2, enablingType = PNlib.Types.EnablingType.Probability, enablingProbOut = {0.5, 0.5}, localSeedIn = 1, localSeedOut = 2) annotation(
