...
model InputConflictProb
  ...
  PNlib.Components.PD P1(maxTokens = 2, nIn = 2, nOut = 1, enablingType = PNlib.Types.EnablingType.Probability, localSeedIn = 1, localSeedOut = 2) annotation(
  ...
  PNlib.Components.PD P2(startTokens = 5, nOut = 1, localSeedIn = 3, localSeedOut = 4) annotation(
    Placement(transformation(extent = {{-50, 10}, {-30, 30}})));
  PNlib.Components.PD P3(startTokens = 5, nOut = 1, localSeedIn = 5, localSeedOut = 6) annotation(
