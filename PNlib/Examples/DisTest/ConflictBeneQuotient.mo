...
model ConflictBeneQuotient
  ...
  PNlib.Components.PD P1(benefitType = PNlib.Types.BenefitType.BenefitQuotient, enablingBeneOut = {10, 7}, enablingType = PNlib.Types.EnablingType.Benefit, nIn = 1, nOut = 2, startTokens = 9) annotation(
    Placement(transformation(extent = {{-30, -10}, {-10, 10}})));
  PNlib.Components.TD T1(arcWeightIn = {5}, nIn = 1, nOut = 1) annotation(
  ...
  PNlib.Components.TD T3(arcWeightOut = {4}, nOut = 1) annotation(
