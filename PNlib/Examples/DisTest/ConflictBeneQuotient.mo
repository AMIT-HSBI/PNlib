...
model ConflictBeneQuotient
  ...
  PNlib.PD P1(benefitType = PNlib.Types.BenefitType.BenefitQuotient, enablingBeneOut = {10, 3},nIn = 1, nOut = 2, startTokens = 9) annotation(Placement(transformation(extent = {{-30, -10}, {-10, 10}})));
