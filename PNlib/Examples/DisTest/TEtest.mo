...
model TEtest
  ...
  inner PNlib.Components.Settings settings annotation(
    Placement(visible = true, transformation(extent = {{60, 20}, {80, 40}}, rotation = 0)));
  ...
  PNlib.Components.TE T1(nIn = 1, nOut = 1) annotation(
...
equation
  ...
  annotation(
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-80, -40}, {80, 40}}), graphics),
