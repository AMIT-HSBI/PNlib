...
model SixConflictProb
  ...
  PNlib.Components.PD P1(startTokens = 1, enablingType = PNlib.Types.EnablingType.Probability, nOut = 6,
    localSeedIn=1,
  ...
  PNlib.Components.TD T4(nIn = 1) annotation(Placement(transformation(extent={{20, -30}, {40,
            -10}})));
