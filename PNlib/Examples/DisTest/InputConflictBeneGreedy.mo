...
model InputConflictBeneGreedy
  ...
  PNlib.PD P1(enablingBeneIn = {1, 2},enablingType = PNlib.Types.EnablingType.Benefit,maxTokens = 2, nIn = 2, nOut = 1) annotation(Placement(transformation(extent={{10, -10},
            {30, 10}})));
