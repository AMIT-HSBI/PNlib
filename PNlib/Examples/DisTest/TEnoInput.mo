...
model TEnoInput
  ...
  inner PNlib.Settings settings annotation(Placement(visible = true, transformation(extent = {{20, 20}, {40, 40}}, rotation = 0)));
  PNlib.PD P1(nIn = 1, startTokens = 0) annotation(Placement(visible = true, transformation(extent={{10, -10}, {30, 10}},                                                                                                               rotation = 0)));
  PNlib.TE T2(event = {0.5, 2.5, 2.8}, nOut = 1)  annotation (
