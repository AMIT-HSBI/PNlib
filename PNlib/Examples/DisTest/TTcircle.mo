...
model TTcircle
  ...
  inner PNlib.Components.Settings settings annotation(
    Placement(visible = true, transformation(extent = {{30, 30}, {50, 50}}, rotation = 0)));
  PNlib.Components.PD P1(nIn = 1, nOut = 1, startTokens = 1) annotation(
    Placement(visible = true, transformation(extent = {{-30, 8}, {-10, 28}}, rotation = 0)));
  PNlib.Components.TT T1(nIn = 1, nOut = 1, tactIntervall = 1, tactStart = 0) annotation(
    Placement(visible = true, transformation(origin = {0, 18}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  PNlib.Components.PD P2(nIn = 1, nOut = 1) annotation(
    Placement(visible = true, transformation(origin = {22, 18}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  PNlib.Components.TT T2(nIn = 1, nOut = 1, tactIntervall = 2, tactStart = 1.5) annotation(
